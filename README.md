...
## Explicación del uso de *pointers* en el proyecto

Dentro del sistema, los *pointers* son esenciales para modelar las relaciones entre objetos sin necesidad de duplicar información. Esto se utiliza principalmente en la clase `Adopcion`, donde se requiere asociar directamente:

* Un objeto `Adoptante`
* Un objeto `Rescatista`
* Un objeto `Mascota`

En lugar de almacenar copias completas de estos objetos dentro de la adopción, el sistema utiliza:
...
1. **Eficiencia en memoria:** Se evita duplicar objetos grandes (como Mascota o Persona) en cada adopción.
2. **Consistencia de datos:** Si el adoptante o la mascota se modifican desde otra parte del programa, los cambios se reflejan automáticamente en todas las adopciones que los referencian.
3. **Modelado más realista:** Una adopción no “posee” completamente a una persona o a una mascota; simplemente hace referencia a ellas. Este comportamiento coincide con la relación UML de agregación.
4. **Flexibilidad:** Permite gestionar listas dinámicas de objetos y asignarlos a adopciones sin necesidad de reconstruir objetos completos.

En resumen, los *pointers* permiten que las clases interactúen entre sí de manera eficiente, flexible y coherente con el diseño orientado a objetos.
