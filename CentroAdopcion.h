...
public:
  ...
  std::string getLugar() { return lugar; }
  int getHijos() { return hijos; }
  int getMascotasExistentes() { return mascotasExistentes; }
  int getTiempoParaMascota() { return tiempoParaMascota; }
  std::string getActividadFisica() { return actividadFisica; }

  void setFecha(std::string newFecha) { fecha = newFecha; }
  void setLugar(std::string newLugar) { lugar = newLugar; }
  void setHijos(int newHijos) { hijos = newHijos; }
