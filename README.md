...
Desarrollar un sistema claro, escalable y modular que permita simular y gestionar el proceso completo de adopción, ideal para prácticas académicas de POO.
...
La arquitectura está basada en composición y agregación para reflejar cómo interactúan las entidades reales dentro de un sistema de adopción.
